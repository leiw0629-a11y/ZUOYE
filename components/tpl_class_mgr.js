        ...
        <!-- 2. 下方主要内容区 -->
			<div class="cm-body">
				...
				<div class="cm-sidebar">
					...
					<div class="cm-menu-item" onclick="showSubjectSettings()" id="menu-subject-settings">
					   <span class="cm-menu-icon">📚</span>
					   <span>科目设置</span>
				   </div>
					<!-- 底部小贴士 -->
			...
			<div id="view-subject-settings" style="display: none; flex-direction: column; height: 100%;">
       <div class="cm-form-body">
           
           <div style="margin-bottom: 10px; text-align: center; color: #999; font-size: 13px;">
               请录入所有课程名称，一行一个。
           </div>

           <div class="cm-form-group" style="flex: 1; display: flex; flex-direction: column;">
               <div class="cm-label-row">
                   <label class="cm-label">📚 科目列表 <span style="font-weight:normal; color:#999; font-size:13px;">(一行一个)</span></label>
               </div>
               <textarea class="cm-textarea" id="cm-subject-list" placeholder="语文&#10;数学&#10;英语&#10;科学&#10;..."></textarea>
           </div>

           <div style="margin-top: 20px; text-align: center;">
               <button class="cm-btn-create-big" onclick="saveSubjectSettings()">💾 保存设置</button>
           </div>
